  ...
  describe '#get_feed' do
    ...
    context 'as a student with Undergrad and UCBX transfer credits' do
      ...
      it 'parses detailed data, casting Numerical values to Floats' do
        ...
        expect(subject[:undergraduate][:detailed][0].count).to eq 7
        ...
        expect(subject[:undergraduate][:detailed][1].count).to eq 7
    ...
    context 'as a student with graduate and law career credits' do
      ...
      context 'not currently a law student' do
        ...
        it 'parses detailed data, casting Numerical values to Floats' do
          expect(subject[:graduate][:detailed][0].count).to eq 7
          ...
          expect(subject[:law][:detailed][0].count).to eq 7
          ...
          expect(subject[:law][:detailed][1].count).to eq 7
