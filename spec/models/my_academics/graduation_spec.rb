describe MyAcademics::Graduation do
  ...
  let(:career) { { 'code' => 'UGRD', :role => 'ugrd' } }
  let(:second_career) { { 'code' => 'GRAD', :role => 'grad' } }
  ...
  context 'is not graduate or law career student' do
    ...
    context 'when law career present' do
      let(:second_career) { { 'code' => 'LAW', :role => 'law' } }
      it 'returns false' do
        expect(subject).to eq false
      end
    end
    context 'when no law or graduate career present' do
      let(:second_career) { { 'code' => 'UGRD', :role => 'ugrd' } }
      it 'returns true' do
