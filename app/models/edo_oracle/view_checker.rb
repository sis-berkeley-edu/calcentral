class EdoOracle::ViewChecker
  ...
  VIEW_DEPENDENCIES_CLC_SISEDO = [
    ...
    },
    {
      ...
      :columns => %w(STUDENT_ID CAMPUS_UID AID_YEAR UC_COST_ATTENDANCE UC_GIFT_AID_WAIVER UC_THIRD_PARTY UC_NET_COST UC_FUNDING_OFFERED UC_GIFT_AID_OUT UC_GRANTS_SCHOL UC_OUTSIDE_RESRCES UC_WAIVERS_OTH UC_FEE_WAIVERS UC_LOANS_WRK_STUDY UC_LOANS UC_WORK_STUDY)
    },
    {
