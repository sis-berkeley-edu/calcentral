...
angular
  ...
  .controller('EnrollmentVerificationController', function(
    apiService,
    ...
    $scope.enrollmentVerificationServices = {
      url:
        'http://registrar.berkeley.edu/academic-records/verification-enrollment-degrees',
    ...
    var parseEnrollmentVerificationData = function(response) {
      ...
      $scope.enrollVerification.requestOfficialVerificationLink = _.get(
        response,
        'data.requestUrl'
      );
      $scope.enrollVerification.lawExclusive = isRoleExclusive(
        'law',
