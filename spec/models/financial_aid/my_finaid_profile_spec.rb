describe FinancialAid::MyFinaidProfile do
  ...
  describe '#get_feed' do
    ...
    it 'returns the expected result' do
      ...
      expect(subject[:finaidProfile][:itemGroups][0][1][:title]).to eq 'Level'
      expect(subject[:finaidProfile][:itemGroups][0][1][:values][0][:subvalue][0]).to eq 'Fall 2017'
      expect(subject[:finaidProfile][:itemGroups][0][1][:values][0][:subvalue][1]).to eq '3rd Year'
      expect(subject[:finaidProfile][:itemGroups][0][1][:values][1][:subvalue][0]).to eq 'Spring 2018'
      expect(subject[:finaidProfile][:itemGroups][0][1][:values][1][:subvalue][1]).to eq '3rd Year'
      expect(subject[:finaidProfile][:itemGroups][0][1][:values][2][:subvalue][0]).to eq 'Summer 2018'
      expect(subject[:finaidProfile][:itemGroups][0][1][:values][2][:subvalue][1]).to eq '4th Year'
      expect(subject[:finaidProfile][:itemGroups][0][2][:title]).to eq 'Expected Graduation'
      expect(subject[:finaidProfile][:itemGroups][0][2][:value]).to eq 'Spring 2019'
      expect(subject[:finaidProfile][:itemGroups][1][0][:title]).to eq 'Candidacy'
      expect(subject[:finaidProfile][:itemGroups][1][0][:value]).to eq nil
      expect(subject[:finaidProfile][:itemGroups][1][1][:title]).to eq 'Filing Fee Status'
      expect(subject[:finaidProfile][:itemGroups][1][1][:value]).to eq nil
      expect(subject[:finaidProfile][:itemGroups][2][0][:title]).to eq 'Academic Holds'
      expect(subject[:finaidProfile][:itemGroups][2][0][:value]).to eq '0'
    ...
    context 'when no aid year is provided' do
      ...
      it 'assumes the default aid year' do
        ...
        expect(subject[:finaidProfile][:itemGroups][0][0][:value]).to eq 'Undergraduate'
        expect(subject[:finaidProfile][:itemGroups][0][1][:title]).to eq 'Level'
        expect(subject[:finaidProfile][:itemGroups][0][1][:values][0][:subvalue][0]).to eq 'Fall 2018'
        expect(subject[:finaidProfile][:itemGroups][0][1][:values][0][:subvalue][1]).to eq '4th Year'
        expect(subject[:finaidProfile][:itemGroups][0][1][:values][1][:subvalue][0]).to eq 'Spring 2019'
        expect(subject[:finaidProfile][:itemGroups][0][1][:values][1][:subvalue][1]).to eq '4th Year'
        expect(subject[:finaidProfile][:itemGroups][0][2][:title]).to eq 'Expected Graduation'
        expect(subject[:finaidProfile][:itemGroups][0][2][:value]).to eq 'Spring 2019'
        expect(subject[:finaidProfile][:itemGroups][1][0][:title]).to eq 'Candidacy'
        expect(subject[:finaidProfile][:itemGroups][1][0][:value]).to eq nil
