module CalCentralPages
  ...
  module MyFinancesPages
    ...
    div(:finaid_summary_label, :class => 'cc-widget-financial_aid-summary-label')
    ...
    select_list(:finaid_multi_year_select, :id => 'cc-widget-financial_aid-summary-select-year')
    span(:finaid_semesters, :xpath => '//span[@data-ng-bind="selected.finaidYear.availableSemesters | andFilter"]')

    div(:net_cost_section, :class => 'cc-widget-financial_aid-summary-netcost-summary')
    ...
    div(:finaid_funding_offered_ttl, :xpath => '//div[@class="cc-widget-financial_aid-summary-funding-offered ng-scope"]//span[text()="Funding Offered"]/../following-sibling::div')
    div(:finaid_funding_gift_aid, :xpath => '//div[@class="cc-widget-financial_aid-summary-funding-offered ng-scope"]//span[text()="Gift Aid"]/../following-sibling::div')
    div(:finaid_funding_grants, :xpath => '//div[@class="cc-widget-financial_aid-summary-funding-offered ng-scope"]//span[text()="Grants and Scholarships"]/../following-sibling::div')
    div(:finaid_funding_waivers, :xpath => '//div[@class="cc-widget-financial_aid-summary-funding-offered ng-scope"]//span[text()="Fee Waivers"]/../following-sibling::div')
    div(:finaid_funding_other, :xpath => '//div[@class="cc-widget-financial_aid-summary-funding-offered ng-scope"]//span[text()="Other Funding"]/../following-sibling::div')
    div(:finaid_funding_loans, :xpath => '//div[@class="cc-widget-financial_aid-summary-funding-offered ng-scope"]//span[text()="Loans"]/../following-sibling::div')
    div(:finaid_funding_work_study, :xpath => '//div[@class="cc-widget-financial_aid-summary-funding-offered ng-scope"]//span[text()="Work Study"]/../following-sibling::div')
