class RemoveEtsTables < ActiveRecord::Migration[4.2]
  def up
    drop_table :canvas_site_mailing_list_members if ActiveRecord::Base.connection.table_exists? 'canvas_site_mailing_list_members'
    drop_table :canvas_site_mailing_lists if ActiveRecord::Base.connection.table_exists? 'canvas_site_mailing_lists'
    drop_table :canvas_synchronization if ActiveRecord::Base.connection.table_exists? 'canvas_synchronization'
    drop_table :webcast_course_site_log if ActiveRecord::Base.connection.table_exists? 'webcast_course_site_log'
  end

  def down
    unless ActiveRecord::Base.connection.table_exists? 'canvas_site_mailing_list_members'
    ...
    unless ActiveRecord::Base.connection.table_exists? 'canvas_site_mailing_lists'
    ...
    unless ActiveRecord::Base.connection.table_exists? 'canvas_synchronization'
    ...
    unless ActiveRecord::Base.connection.table_exists? 'webcast_course_site_log'
