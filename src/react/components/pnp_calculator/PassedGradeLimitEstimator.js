          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="totalTransferUnits" onChange={props.handleInputChange}/>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="totalGpaUnits" onChange={props.handleInputChange}/>
                </td>
                <td className="cc-react-table-right">
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="totalNoGpaUnits" onChange={props.handleInputChange}/>
                </td>
                <td className="cc-react-table-right">
