describe MyRegistrations::Statuses do
  ...
  let(:hub_student_registrations) { HubEdos::StudentApi::V1::Registrations.new(user_id: 61889, fake: true).get }
  let(:hub_student_attributes) { HubEdos::StudentApi::V1::StudentAttributes.new(user_id: 61889, fake: true).get }
  before(:each) do
