describe HubEdos::StudentApi::V1::StudentAttributes do
  context 'mock proxy' do
    let(:include_fields) { nil }
    let(:proxy) { HubEdos::StudentApi::V1::StudentAttributes.new(fake: true, user_id: '61889', include_fields: include_fields) }
    subject { proxy.get }
