describe FinancialAid::MyFinaidProfile do
  ...
  describe '#get_feed' do
    ...
    it 'returns the expected result' do
      ...
      expect(subject[:finaidProfile][:itemGroups][4][1][:value]).to eq 'Packaged'
      expect(subject[:finaidProfile][:itemGroups][4][2][:title]).to eq 'Verification Status'
      expect(subject[:finaidProfile][:itemGroups][4][2][:value]).to eq 'Verified'
      expect(subject[:finaidProfile][:itemGroups][5][0][:title]).to eq 'Dependency Status'
      expect(subject[:finaidProfile][:itemGroups][5][0][:value]).to eq 'Independent'
      expect(subject[:finaidProfile][:itemGroups][5][1][:title]).to eq 'Expected Family Contribution (EFC)'
      expect(subject[:finaidProfile][:itemGroups][5][1][:value]).to eq '$425'
      expect(subject[:finaidProfile][:itemGroups][5][2][:title]).to eq 'Berkeley Parent Contribution'
      expect(subject[:finaidProfile][:itemGroups][5][2][:value]).to eq '$0'
      expect(subject[:finaidProfile][:itemGroups][5][3][:title]).to eq 'Summer EFC'
      expect(subject[:finaidProfile][:itemGroups][5][3][:value]).to eq '$0'
      expect(subject[:finaidProfile][:itemGroups][5][4][:title]).to eq 'Family Members in College'
      expect(subject[:finaidProfile][:itemGroups][5][4][:value]).to eq '1'
      expect(subject[:finaidProfile][:itemGroups][6][0][:title]).to eq 'Residency'
      expect(subject[:finaidProfile][:itemGroups][6][0][:values][0][:subvalue][0]).to eq 'Fall 2017'
      expect(subject[:finaidProfile][:itemGroups][6][0][:values][0][:subvalue][1]).to eq 'Resident'
      expect(subject[:finaidProfile][:itemGroups][6][0][:values][1][:subvalue][0]).to eq 'Spring 2018'
      expect(subject[:finaidProfile][:itemGroups][6][0][:values][1][:subvalue][1]).to eq 'Resident'
      expect(subject[:finaidProfile][:itemGroups][6][0][:values][2][:subvalue][0]).to eq 'Summer 2018'
      expect(subject[:finaidProfile][:itemGroups][6][0][:values][2][:subvalue][1]).to eq 'Resident'
      expect(subject[:finaidProfile][:itemGroups][7][0][:title]).to eq 'Enrollment'
      expect(subject[:finaidProfile][:itemGroups][7][0][:values][0][:subvalue][0]).to eq 'Fall 2017'
      expect(subject[:finaidProfile][:itemGroups][7][0][:values][0][:subvalue][1]).to eq '12 Units'
      expect(subject[:finaidProfile][:itemGroups][7][0][:values][1][:subvalue][0]).to eq 'Spring 2018'
      expect(subject[:finaidProfile][:itemGroups][7][0][:values][1][:subvalue][1]).to eq '12 Units'
      expect(subject[:finaidProfile][:itemGroups][7][0][:values][2][:subvalue][0]).to eq 'Summer 2018'
      expect(subject[:finaidProfile][:itemGroups][7][0][:values][2][:subvalue][1]).to eq '7 Units'
      expect(subject[:finaidProfile][:itemGroups][8][0][:title]).to eq 'SHIP (Student Health Insurance Program)'
      expect(subject[:finaidProfile][:itemGroups][8][0][:values][0][:subvalue][0]).to eq 'Fall 2017'
      expect(subject[:finaidProfile][:itemGroups][8][0][:values][0][:subvalue][1]).to eq 'Enrolled'
      expect(subject[:finaidProfile][:itemGroups][8][0][:values][1][:subvalue][0]).to eq 'Spring 2018'
      expect(subject[:finaidProfile][:itemGroups][8][0][:values][1][:subvalue][1]).to eq 'Enrolled'
      expect(subject[:finaidProfile][:itemGroups][8][0][:values][2][:subvalue][0]).to eq 'Summer 2018'
      expect(subject[:finaidProfile][:itemGroups][8][0][:values][2][:subvalue][1]).to eq 'Enrolled'
    end
    ...
    context 'when no aid year is provided' do
      ...
      it 'assumes the default aid year' do
        ...
        expect(subject[:finaidProfile][:itemGroups][5][0][:value]).to eq 'Independent'
        expect(subject[:finaidProfile][:itemGroups][5][1][:title]).to eq 'Expected Family Contribution (EFC)'
        expect(subject[:finaidProfile][:itemGroups][5][1][:value]).to eq '$0'
        expect(subject[:finaidProfile][:itemGroups][5][2][:title]).to eq 'Berkeley Parent Contribution'
        expect(subject[:finaidProfile][:itemGroups][5][2][:value]).to eq '$0'
        expect(subject[:finaidProfile][:itemGroups][5][3][:title]).to eq 'Summer EFC'
        expect(subject[:finaidProfile][:itemGroups][5][3][:value]).to eq nil
        expect(subject[:finaidProfile][:itemGroups][5][4][:title]).to eq 'Family Members in College'
        expect(subject[:finaidProfile][:itemGroups][5][4][:value]).to eq '2'
        expect(subject[:finaidProfile][:itemGroups][6][0][:title]).to eq 'Residency'
        ...
        expect(subject[:finaidProfile][:itemGroups][7][0][:values][1][:subvalue][1]).to eq '16 Units'
        expect(subject[:finaidProfile][:itemGroups][8][0][:title]).to eq 'SHIP (Student Health Insurance Program)'
        expect(subject[:finaidProfile][:itemGroups][8][0][:values][0][:subvalue][0]).to eq 'Fall 2018'
        expect(subject[:finaidProfile][:itemGroups][8][0][:values][0][:subvalue][1]).to eq 'Enrolled'
        expect(subject[:finaidProfile][:itemGroups][8][0][:values][1][:subvalue][0]).to eq 'Spring 2019'
        expect(subject[:finaidProfile][:itemGroups][8][0][:values][1][:subvalue][1]).to eq 'Enrolled'
      end
    end
  end
