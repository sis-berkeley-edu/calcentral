describe BackgroundJob do
  describe '.unique_job_id' do
    ...
    it 'returns unique job id based on current time' do
      ...
      expect(result).to eq '2017-02-03T14:37:18-08:00-67f4b934525501cb'
    end
  ...
  describe '.find' do
    it 'returns the current job object from global storage' do
      ...
      Rails.cache.write('Canvas::Egrades.2017-02-03T14:37:18-08:00-67f4b934525501cb', job_state, expires_in: 5.seconds.to_i, raw: true)
      result = BackgroundJob.find('Canvas::Egrades.2017-02-03T14:37:18-08:00-67f4b934525501cb')
