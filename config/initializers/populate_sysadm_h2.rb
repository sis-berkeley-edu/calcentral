  ...
  Rails.application.config.after_initialize do
    ...
    if Settings.edodb.adapter == 'h2'
      ...
      CREATE TABLE SYSADM.PS_UCC_FA_PRFL_ENR (
        ...
        STRM                        VARCHAR2(4 CHAR),
        DESCR                       VARCHAR2(30 CHAR),
        TOT_TERM_UNT_FA             NUMBER(5,3),
        DESCR2                      VARCHAR2(30 CHAR)
      );

      INSERT INTO SYSADM.PS_UCC_FA_PRFL_ENR (EMPLID,CAMPUS_ID,INSTITUTION,AID_YEAR,STRM,DESCR,TOT_TERM_UNT_FA,DESCR2) VALUES ('11667051','61889','UCB01','2018','2178','Fall 2017',12,'Enrolled');
      INSERT INTO SYSADM.PS_UCC_FA_PRFL_ENR (EMPLID,CAMPUS_ID,INSTITUTION,AID_YEAR,STRM,DESCR,TOT_TERM_UNT_FA,DESCR2) VALUES ('11667051','61889','UCB01','2018','2182','Spring 2018',12,'Enrolled');
      INSERT INTO SYSADM.PS_UCC_FA_PRFL_ENR (EMPLID,CAMPUS_ID,INSTITUTION,AID_YEAR,STRM,DESCR,TOT_TERM_UNT_FA,DESCR2) VALUES ('11667051','61889','UCB01','2018','2185','Summer 2018',7,'Enrolled');
      INSERT INTO SYSADM.PS_UCC_FA_PRFL_ENR (EMPLID,CAMPUS_ID,INSTITUTION,AID_YEAR,STRM,DESCR,TOT_TERM_UNT_FA,DESCR2) VALUES ('11667051','61889','UCB01','2019','2188','Fall 2018',12,'Enrolled');
      INSERT INTO SYSADM.PS_UCC_FA_PRFL_ENR (EMPLID,CAMPUS_ID,INSTITUTION,AID_YEAR,STRM,DESCR,TOT_TERM_UNT_FA,DESCR2) VALUES ('11667051','61889','UCB01','2019','2192','Spring 2019',16,'Enrolled');
