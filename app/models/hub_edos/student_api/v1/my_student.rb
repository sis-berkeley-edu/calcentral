    ...
    module V1
      class MyStudent < UserSpecificModel
        ...
        def get_feed_internal
          ...
          [HubEdos::StudentApi::V1::Contacts, HubEdos::StudentApi::V1::Demographics, HubEdos::StudentApi::V1::Gender, HubEdos::StudentApi::V1::Affiliations].each do |proxy|
            break if (proxy == HubEdos::StudentApi::V1::Affiliations) && merged[:feed][:student]['affiliations'].present?
