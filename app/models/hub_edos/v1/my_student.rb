  ...
  module V1
    class MyStudent < UserSpecificModel
      ...
      def get_feed_internal
        ...
        [HubEdos::V1::Contacts, HubEdos::V1::Demographics, HubEdos::V1::Gender, HubEdos::V1::Affiliations].each do |proxy|
          break if (proxy == HubEdos::V1::Affiliations) && merged[:feed][:student]['affiliations'].present?
